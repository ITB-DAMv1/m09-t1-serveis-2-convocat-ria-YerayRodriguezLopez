...
namespace EventAPI.DTOs
{
    public class RegisterClientDto
    {
        ...
        [StringLength(100, ErrorMessage = "El nom del CEO no pot superar els 100 caràcters")]
        public string CeoFirstName { get; set; }

        [Required(ErrorMessage = "Els cognoms del CEO són obligatoris")]
        [StringLength(100, ErrorMessage = "Els cognoms del CEO no poden superar els 100 caràcters")]
